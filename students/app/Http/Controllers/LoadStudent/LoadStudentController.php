...
class LoadStudentController extends Controller{
    ...
    public function loadStudents($type="",$param=""){
        ...
        if($type=="ECCD"){
            ...
            $query = "SELECT COUNT(CASE WHEN s.CmnSexId='353db3f5-1b97-406b-88ba-a68dbe53b2aa' THEN 1 END) malecount,
            COUNT(CASE WHEN s.CmnSexId='86164859-5be8-4ac8-8b40-7616d222229e' THEN 1 END) femalecount,COUNT(*) totalstd
