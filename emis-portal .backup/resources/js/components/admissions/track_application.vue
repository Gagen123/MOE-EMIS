                    ...
                    <label class="mb-0">Track Application:</label>
                        ...
                        <div class="row form-group">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input type="text" class="form-control" @keyup.enter="applicationDetailsbyCID('cid_passport')" @blur="applicationDetailsbyCID('cid_passport',)" :class="{ 'is-invalid': form.errors.has('cid_passport') }" id="cid_passport" v-model="form.cid_passport" placeholder="Ref/cid No">
