...
export default {
    ...
    methods: {
        ...
        loadworkingagencyList(uri = 'masters/load_staff_masters/all_active_staff_major_groupList'){
            axios.get(uri)
            .then(response => {
                let data = response;
    ...
    created() {
        ...
        this.form.parent_field=this.$route.params.data.majorgroup.id;
