            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <input class="form-control" v-model="form.screeningName" :class="{ 'is-invalid': form.errors.has('src_name') }" id="screeningName" @change="remove_err('screeningName')" type="text" tabindex="1" autofocus="true">
        ...
        formaction: function(type){
            ...
            if(type=="save"){
                this.form.post('masters/saveScreening',this.form)
                    ...
                    Toast.fire({
                        icon: 'success',
                        title: 'Health Screening Type is added successfully'
                    })
