...
class SpmNonStemSubjectPoint extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('spm_non_stem_subject_point', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('spm_non_stem_subject_point');
    }
}
