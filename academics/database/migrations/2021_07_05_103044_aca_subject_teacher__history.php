...
class AcaSubjectTeacherHistory extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aca_sub_teacher_history', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('aca_sub_teacher_history');
    }
}
