package com.spring.mvc.integration.birt.report.service;

import com.spring.mvc.crypto.DBPasswordProtectorUtil;
...
import com.spring.mvc.integration.birt.report.enumeration.domain.ReportGenerationStatus;
...
public class ReportService {
    ...
    public static ReportResponseDto createReport(ReportRequestDto reportRequestDto) throws JRException,
        ...
        String path = reportRequestDto.getReportOutputDir() + "/" + reportRequestDto.getReportName() +  "." + reportRequestDto.getReportFormat();
        ...
        return new ReportResponseDto(
                status,
                path,
                reportRequestDto.getReportName()  + "." + reportRequestDto.getReportFormat());
    }
