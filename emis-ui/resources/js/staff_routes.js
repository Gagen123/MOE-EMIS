    ...
    { path: '/qualification_index',
        ...
        children:[
            ...
            { path: '/qualification_description',
                component: require('./components/masters/staff_qualification/qualification_description/qualification_description_index.vue').default,
                children:[
                    { path: '/',name:'qualification_description', component: require('./components/masters/staff_qualification/qualification_description/list_qualification_description.vue').default },
                    { path: '/list_qualification_description',name:'list_qualification_description', component: require('./components/masters/staff_qualification/qualification_description/list_qualification_description.vue').default },
                    { path: '/create_qualification_description',name:'create_qualification_description', component: require('./components/masters/staff_qualification/qualification_description/create_qualification_description.vue').default },
                    { path: '/edit_qualification_description', name:'edit_qualification_description', component: require('./components/masters/staff_qualification/qualification_description/edit_qualification_description.vue').default },
                ],
            },
