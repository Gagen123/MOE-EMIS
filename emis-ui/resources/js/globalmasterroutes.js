const global_routes = [
    ...
    children:[
        ...
        { path: '/guidelines',
            component: require('./components/masters/global_masters/guidelines/guidelines_index.vue').default,
            children:[
            { path: '/',name:'guidelines', component: require('./components/masters/global_masters/guidelines/list_guidelines.vue').default },
            { path: '/list_guidelines',name:'list_guidelines', component: require('./components/masters/global_masters/guidelines/list_guidelines.vue').default },
            { path: '/create_guidelines', name:'create_guidelines', component: require('./components/masters/global_masters/guidelines/create_guidelines.vue').default },
