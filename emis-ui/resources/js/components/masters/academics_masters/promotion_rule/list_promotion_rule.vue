    ...
    <div>
        <div class="form-group row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <table id="promotion-rule-list-table" class="table display table-sm table-bordered table-striped">
                    <thead>
                        <tr>
                         <th>SL#</th>
                        <th>Class</th>
...
export default {
    ...
    methods:{
        ...
        showedit(data){
            this.$router.push({name:'edit_promotion_rule',params: {data:data}});
        },
    },
    mounted(){ 
        this.getClassStreamList();
        this.dt =  $("#promotion-rule-list-table").DataTable({
            distroy:true,
        })
    },
    watch: {
