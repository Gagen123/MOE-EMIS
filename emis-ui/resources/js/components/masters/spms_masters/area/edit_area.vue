                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                     ...
                     <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <select class="form-control select2" id="spm_domain_id" v-model="form.spm_domain_id" :class="{ 'is-invalid': form.errors.has('spm_domain_id') }"  @change="remove_err('spm_domain_id')">
