<template>
    <div> 
        <ol class="mb-1 ml-xl-n3 mr-xl-n2" style="background-color:#E5E5E5">
            <li class="pl-2 form-inline "><h6 class="pt-1">Staff Masters</h6></li>
        </ol>
        <div class="container-fluid">
            <ul class="nav nav-pills mb-2" role="tablist">
                ...
                <li class="nav-item active pr-1">
                    <router-link :to="{name: 'working_agency_master'}" class="btn btn-outline-primary btn-sm pb-0 pl-1 pr-1 pt-0"  onclick="afterclick()">
                       Working Agency
                    </router-link>
                </li>
                <li class="nav-item active pr-1">
                ...
                <li class="nav-item active pr-1">
                 ...
                 <li class="nav-item active pr-1" @click="activatelink('teaching_subjects')">
