...
export default {
		...
		formaction: function(type){
            ...
            if(type=="save"){
                this.form.post('staff/saveStaffMasters',this.form)
                    ...
                    this.$router.push({name:'list_'+this.$props.model, query: {model:this.$props.model}});
                })
                .catch((error) => {
    ...
    created() {
        this.form.model=this.$props.model;
        this.form.name=this.$props.data.name;
        this.form.status=this.$props.data.status;
        this.form.code=this.$props.data.code;
        this.form.description=this.$props.data.description;
