            ...
            <div class="card-body">
                <div class="row form-group">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>Nature of Participant:<span class="text-danger">*</span></label>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>Code:</label>
                        <input class="form-control" v-model="form.code" disabled :class="{ 'is-invalid': form.errors.has('code') }" id="dzongkhagcode" @change="remove_error('dzongkhagcode')" type="number">
...
export default {
    data() {
        return {
            ...
            form: new form({
                ...
                code:'',
                status:'',
                model:'hr_development_masters___NatureOfParticipant',
                action_type:'edit',
            })
        }
    },
    methods: {
		formaction: function(type){
            ...
            if(type=="save"){
                this.submitstaffmaster('list_nature_of_participation');
            }
		},
    },
    created() {
