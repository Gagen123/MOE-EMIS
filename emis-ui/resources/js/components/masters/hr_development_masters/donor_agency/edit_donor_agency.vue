        ...
        <form class="bootbox-form" id="dzongkhagId">
            <div class="card-body">
                <div class="row form-group">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>Code:</label>
                        <input class="form-control" v-model="form.code" :class="{ 'is-invalid': form.errors.has('code') }" id="dzongkhagcode" @change="remove_err('dzongkhagcode')" type="number">
...
export default {
    data() {
        return {
            ...
            form: new form({
                ...
                code:'',
                status:'',
                model:'hr_development_masters___Donor',
                action_type:'edit',
            })
        }
    },
    methods: {
		formaction: function(type){
            ...
            if(type=="save"){
                this.submitstaffmaster('list_donor_agency');
            }
		},
    },
    created() {
