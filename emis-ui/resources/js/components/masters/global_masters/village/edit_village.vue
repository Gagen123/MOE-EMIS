            ...
            <div class="card-body">
                <div class="row form-group">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <select class="form-control select2" id="dzo_id" v-model="form.grand_parent_field_id">
...
export default {
    ...
    methods: {
        ...
        getgewoglist(){
            ...
            if(dzoId==undefined){
                dzoId=this.$route.params.data.dzothroughgewog.id;
            }
    ...
    created() {
        ...
        this.form.grand_parent_field_id=this.$route.params.data.dzothroughgewog.id;
        this.form.parent_field=this.$route.params.data.gewog.id;
