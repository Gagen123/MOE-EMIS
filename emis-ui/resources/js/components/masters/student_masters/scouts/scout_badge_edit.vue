            ...
            <div class="card-body">
                <div class="row form-group">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 pt-2">
                        <label>Scout Proficiency Badge Name:<span class="text-danger">*</span></label> 
...
export default {
    ...
    methods: {
		...
		formaction: function(type){
            if(type=="reset"){
             ...
             if(type=="save"){
                this.submitstudentmaster('scout_badge_list');
            }
		}, 
    },
    created() {
    ...
    mounted() {
        ...
        created() {
            ...
            this.form.scout_type=this.$route.params.data.CeaScoutSectionId;
