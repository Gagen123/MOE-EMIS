        ...
        <table id="org-masters-table" class="table table-bordered text-sm table-striped">
            <thead>
                <tr>
                    ...
                    <th style="width:20%">Construction Type</th>
...
export default {
    ...
    methods:{
        loadConstructionList(uri = 'masters/organizationMasterController/loadOrganizaitonmasters/all/ConstructionType'){
            axios.get(uri)
            .then(response => {
        ...
        editmasters(data){
            this.$router.push({name:'edit_construction_type',params: {data:data}});
        },
    },
    mounted(){
