        ...
        <table id="org-masters-table" class="table table-bordered text-sm table-striped">
            <thead>
                <tr>
                    ...
                    <th style="width:20%">Visitor Type</th>
...
export default {
    ...
    methods:{
        loadContactList(uri = 'masters/organizationMasterController/loadOrganizaitonmasters/all/VisitorType'){
            axios.get(uri)
            .then(response => {
        ...
        editmasters(data){
            this.$router.push({name:'edit_visitor',params: {data:data}});
        },
    },
    mounted(){
