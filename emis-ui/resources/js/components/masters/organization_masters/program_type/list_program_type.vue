...
export default {
    ...
    methods:{
        loadProgramList(uri = 'masters/organizationMasterController/loadOrganizaitonmasters/all/ProgramType'){
            axios.get(uri)
            .then(response => {
        ...
        editmasters(data){
            this.$router.push({name:'edit_program_type',params: {data:data}});
        },
    },
    mounted(){
