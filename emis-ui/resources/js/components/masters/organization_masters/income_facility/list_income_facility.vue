...
export default {
    ...
    methods:{
        loadContactList(uri = 'masters/organizationMasterController/loadOrganizaitonmasters/all/IncomeType'){
            axios.get(uri)
            .then(response => {
        ...
        editmasters(data){
            this.$router.push({name:'edit_income_facility',query: {data:data}});
        },
    },
    mounted(){
