...
export default {
    ...
    methods:{
        loadEccdInfraList(uri = 'masters/organizationMasterController/loadOrganizaitonmasters/all/ECCDStructureType'){
            axios.get(uri)
            .then(response => {
        ...
        editmasters(data){
            this.$router.push({name:'edit_eccdStructure_type',params: {data:data}});
        },
    },
    mounted(){
        this.loadEccdInfraList();
