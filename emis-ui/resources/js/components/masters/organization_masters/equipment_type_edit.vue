<template>
    <div>
        <form class="bootbox-form" id="equipmentTypeId">
            <div class="card-body">
                <div class="row form-group">
                    <input type="hidden" class="form-control" v-model="form.id"/>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>Equipment Type Name:<span class="text-danger">*</span></label> 
...
export default {
    ...
    methods:{
        ...
        formaction: function(type){
            ...
            if(type=="save"){
                this.form.post('/masters/saveEquipmentType',this.form)
                    .then(() => {
                    Toast.fire({
                        icon: 'success',
                        title: 'Equipment type details is updated successfully'
                    })
                    this.$router.push('/equipment_type_list');
                })
                .catch(() => {
                    console.log("Error......")
                })
