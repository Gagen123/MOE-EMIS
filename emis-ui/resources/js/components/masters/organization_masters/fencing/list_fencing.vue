        ...
        <table id="org-masters-table" class="table table-bordered text-sm table-striped">
            <thead>
                <tr>
                    ...
                    <th style="width:20%">Fencing Type</th>
...
export default {
    ...
    methods:{
        loadContactList(uri = 'masters/organizationMasterController/loadOrganizaitonmasters/all/FencingType'){
            axios.get(uri)
            .then(response => {
        ...
        editmasters(data){
            this.$router.push({name:'edit_fencing',params: {data:data}});
        },
    },
    mounted(){
