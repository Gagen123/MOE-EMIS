...
export default {
    ...
    methods:{
        loadContactList(uri = 'masters/organizationMasterController/loadOrganizaitonmasters/all/DocumentType'){
            axios.get(uri)
            .then(response => {
        ...
        editmasters(data){
            this.$router.push({name:'edit_document_type',query: {data:data}});
        },
    },
    mounted(){
