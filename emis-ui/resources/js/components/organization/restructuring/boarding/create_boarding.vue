                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 pt-3">
                                        ...
                                        <label><input  type="radio" v-model="form.isFeedingSchool" value="1" tabindex=""/> Yes</label>
                                        <label><input  type="radio" v-model="form.isFeedingSchool" value="0" tabindex=""/> No</label>
                                    </div>
                                </div>
                                <div class="form-group row">
...
export default {
    data(){
        return{
            ...
            streamArray:{},
            form: new form({
                organizationId:'',isFeedingSchool:1, application_type:'boarding_change',
                application_for:'Change to Boarding', action_type:'add', status:'Submitted',organization_type:'',
                attachments:
                [{
                        ...
                        .then((response) => {
                            if(response!=""){
                                ...
                                if(response!="" && response!="No Screen"){
                                    let message="Application for Change to Boarding details has been submitted for approval. System Generated application number for this transaction is: <b>"+response.data.data. notification_appNo+'.</b><br> Use this application number to track your application status. <br><b>Thank You !</b>';
    ...
    async mounted() {
        ...
        this.getAttachmentType('ForTransaction__Application_for_Change_to_Boarding');
