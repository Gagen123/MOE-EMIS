...
export default {
    ...
    methods:{
        ...
        loadDataList(uri='organization/loadOrgChangeApplications/Upgradation'){
            axios.get(uri)
            .then(response => {
                let data = response;
        ...
        showedit(data){
            this.$router.push({name:'edit_upgrade',params: {data:data}});
        },
        showview(data){
            this.$router.push({name:'view_upgrade',params: {data:data}});
        },
