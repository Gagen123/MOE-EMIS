...
export default {
    ...
    methods:{
        ...
        loadDataList(uri='organization/loadOrgChangeApplications/Change_in_Feeding_Details'){
            axios.get(uri)
            .then(response => {
                let data = response;
        ...
        showview(data){
            this.$router.push({name:'view_fee_structure',params: {data:data}});
        },
        showedit(data){
            this.$router.push({name:'edit_fee_structure',params: {data:data}});
        },
