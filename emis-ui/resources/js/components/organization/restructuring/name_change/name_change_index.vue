        ...
        <div class="card card-primary card-outline">
            <div class="card-header pt-0 mt-0 pb-0">
                ...
                <span class="fa-pull-right pr-2 py-1">
                    ...
                    <button type="button" class="btn btn-dark text-white btn-sm" @click="showadprocess('create_name_change')"><i class="fa fa-plus"></i> Apply for New Establishment</button>
                </span>
            </div>
