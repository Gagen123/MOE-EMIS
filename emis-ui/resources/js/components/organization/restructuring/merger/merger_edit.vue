                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show tab-content-details" id="organization-tab" role="tabpanel" aria-labelledby="basicdetails">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <label>Select School that will be part of the merger:<span class="text-danger">*</span></label>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <span class="text-blue text-bold" id="megerCategory1">{{org1_details.category  == 'public_school' ? "Public School" :  "Private School"}}</span>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <label>Level:</label>
...
export default {
    ...
    async mounted(){
        ...
        this.form.orgId2=this.$route.params.data.orgId2;
        this.form.year=this.$route.params.data.year;
        this.form.proposedName=this.$route.params.data.pidroposedName;
        ...
        this.form.locationType=this.$route.params.data.locationType;
        ...
        this.form.coLocated=this.$route.params.data.coLocated;
        this.form.class=this.$route.params.data.class;
        this.form.stream=this.$route.params.data.stream;
        this.form.name1=this.$route.params.data.name1;
        this.form.level1=this.$route.params.data.level1;
        this.form.category1=this.$route.params.data.category1;
        this.form.gewog1=this.$route.params.data.gewog1;
        this.form.chiwog1=this.$route.params.data.chiwog1;
        this.form.location1=this.$route.params.data.location1;
        this.form.newOrgType=this.$route.params.data.newOrgType;
