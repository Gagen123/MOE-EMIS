...
export default {
    ...
    methods: {
                        ...
                        .then((response) => {
                            if(response!=""){
                                ...
                                if(response!="" && response!="No Screen"){
                                    let message="Application for Change of Stream has been submitted for approval. System Generated application number for this transaction is: <b>"+response.data.data.notification_appNo+'.</b><br> Use this application number to track your application status. <br><b>Thank You !</b>';
        ...
        loadScreenDetails(){
            axios.get('organizationApproval/getScreenId/Application For Stream Change__'+1)
            .then(response => {
                let data = response.data.data;
