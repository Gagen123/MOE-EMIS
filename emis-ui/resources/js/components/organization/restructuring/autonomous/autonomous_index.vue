        ...
        <div class="card card-primary card-outline">
            <div class="card-header pt-0 mt-0 pb-0">
                <span class="card-title pt-2 mb-0">
                    <b>Applications for Autonomous</b>
                </span>
                <span class="fa-pull-right pr-2 py-1">
                    ...
                    <button type="button" class="btn btn-dark text-white btn-sm" @click="showadprocess('create_autonomous')"><i class="fa fa-plus"></i> Apply for Name Change</button>
                </span>
            </div>
