<template>
    <div>
        <table id="nameChange-table" class="table table-bordered text-sm table-striped">
            <thead>
                <tr>
                    <th>SL#</th>
                    <th>School Name</th>
            ...
            <tbody id="schoolNamechange">
                <tr v-for="(item, index) in nameChangeList" :key="index">
                    ...
                    <td>{{ item.initatorname }}</td>
                    <td>{{ item.proposedName }}</td>
                    <td>
                        <div class="btn-group btn-group-sm">
                            <a href="#" class="btn btn-info" @click="viewnameChangeList(item)"><i class="fas fa-edit"></i ></a>
                        </div>
                    </td>
                </tr>
            </tbody>
...
export default {
    ...
    mounted(){
        ...
        this.dt =  $("#nameChange-table").DataTable();
    },
    watch: {
        nameChangeList(){
            this.dt.destroy();
