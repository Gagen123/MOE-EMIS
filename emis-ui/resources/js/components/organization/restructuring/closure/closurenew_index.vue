        ...
        <div class="card card-primary card-outline">
            <div class="card-header pt-0 mt-0 pb-0"> 
                <span class="fa-pull-right pr-2 py-1">
                    ...
                    <button type="button" class="btn btn-dark text-white btn-sm" @click="showadprocess('closure_add')"><i class="fa fa-plus"></i> Add New </button>
                </span>
            </div>
...
export default {
    methods: {
        showadprocess(type){
            if(type=="closure_add" || type=="closure_edit"){
                this.$router.push("/"+type);
            }
            if(type=="closure_list"){
