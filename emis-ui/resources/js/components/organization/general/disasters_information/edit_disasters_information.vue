...
export default {
    ...
    created() {
        this.form.diastertype=this.$route.params.data.disasterTypeId;
        this.form.diastercomm=this.$route.params.data.diastercomm;
        this.form.cid_passport=this.$route.params.data.name;
        this.form.fullname=this.$route.params.data.cid;
        this.form.sex_id=this.$route.params.data.sex_id;
        this.form.email=this.$route.params.data.email;
        this.form.contactno=this.$route.params.data.contactNo;
        this.form.servining_as=this.$route.params.data.servingAs;
        this.form.fulladdress=this.$route.params.data.placeOfWork;
