        ...
        <form class="bootbox-form" id="equipmentId">
            <div class="card-body">
                <div class="row form-group">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <label>Program/Club:<span class="text-danger">*</span></label> 
...
export default {
    ...
    methods:{
        ...
        getType(uri="masters/loadActiveStudentMasters/CeaProgramType"){
            axios.get(uri)
            .then(response => {
                let data = response;
         ...
         */
        getItem(uri = '/masters/getprogramList/' +this.form.type){
            axios.get(uri)
            .then(response => {
