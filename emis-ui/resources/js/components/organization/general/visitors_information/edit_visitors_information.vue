    ...
    methods: {
        ...
        getVisitorDetails(visId){
            ...
            .then((response) => {  
                ...
                this.form.visitorname               =    data.visitorname;
                this.form.designation               =    data.designation;
                this.form.contact                   =    data.contact
                this.form.minitsryOrAgency          =    data.minitsryOrAgency;
                this.form.date                      =    data.dateOfVisit;
                this.form.noOfhours                 =    data.noOfhours;
                this.form.targetgroup               =    data.targetgroup;
                this.form.deptOrdivision            =    data.deptOrdivision;
                this.form.purposeOfvisit            =    data.purposeOfvisit;
