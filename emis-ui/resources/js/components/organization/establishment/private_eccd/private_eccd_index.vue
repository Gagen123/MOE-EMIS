        ...
        <div class="card card-primary card-outline" id="mainform">
            <div class="card-header pt-0 mt-0 pb-0">
                <span class="card-title pt-2 mb-0">
                        <b>Applications for New Private ECCD Establishment</b>
                </span>
...
export default {
    ...
    mounted() {
        axios.get('common/getScreenAccess/workflow__establishment_of_private_eccd')//workflow will specify that the process have workflow
        .then(response => {
