            ...
            <tbody id="tbody">
                <tr v-for="(item, index) in dataList" :key="index">
                    ...
                    <td>
                        ...
                        <a href="#" v-if="item.status=='Submitted' || item.status=='Notified For Tentative Date'" class="btn btn-info btn-sm text-white" @click="showedit(item)"><i class="fas fa-edit"></i > Edit</a>
                    </td>
                </tr>
            </tbody>
        </table>
