                        ...
                        <div class="callout callout-success">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <span class="text-blue text-bold">{{applicationOrgdetails.proposedLocation}}</span>
                                </div>   
                            </div>
                           <div class="row pb-2">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    ...
                                    <span class="text-blue text-bold">{{applicationOrgdetails.totalLand}}</span>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <label class="mb-0">Type of School:</label>
                                    <span class="text-blue text-bold">{{ applicationOrgdetails.typeOfSchool  == 1 ? "Day" :  "Boarding"}}</span>
                                </div>
                            </div>
                        </div>
                        <hr>
