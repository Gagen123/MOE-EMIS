...
export default {
    data(){
        return{
            ...
            form: new form({
                id: '',application_number:'', proposedName:'', level:'',category:'2', dzongkhag:'', gewog:'', chiwog:'0', proposedLocation:'',
                proprietorCid:'', proprietorName:'', proprietorPhone:'', proprietorMobile:'', proprietorEmail:'', totalLand:'',
                enrollmentBoys:'', enrollmentGirls:'', typeOfSchool:'', establishment_type:'private_school', status:'Submitted',
                action_type:'edit',
            }),
    ...
    methods: {
        loadApplicaitonDetials(){
            ...
            .then(response => {
                ...
                this.form.id=data.estb_details.id;
                ...
                this.form.totalLand=data.estb_details.totalLand;
                this.form.enrollmentBoys=data.estb_details.enrollmentBoys;
                this.form.enrollmentGirls=data.estb_details.enrollmentGirls;
                    ...
                    if (result.isConfirmed) {
                        ...
                        .then((response) => {
                            ...
                            if(response!="" && response!="No Screen"){
                                let message="Applicaiton for new Establishment has been updated and submitted for further action. <br><b>Thank You !</b>";
