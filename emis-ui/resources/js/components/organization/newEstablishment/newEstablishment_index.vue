    ...
    <div class="container-fluid"> 
        <ul class="nav nav-pills mb-3" id="mainmenu" role="tablist">
            ...
            <li class="nav-item pr-1"  @click="activatelink('new_establishment_index')">
                <router-link id="newOrganization_index" to="/newOrganization_index" class="btn btn-outline-primary btn-sm pb-0 pl-1 pr-1 pt-0">
                   <span class=""></span>
                   New Establishment
                </router-link>
            </li> 
            <li class="nav-item pr-1" @click="activatelink('register')">
                <router-link to ="/registerOrg_index" id="registerOrg_index" class="btn btn-outline-primary btn-sm pb-0 pl-1 pr-1 pt-0">
                    <span class=""></span>
                    Register
                </router-link>
            </li>
            <li class="nav-item pr-1" @click="activatelink('head_quater_office')">
                <router-link to="/headQuarter_index" id="headQuarter_index" class="btn btn-outline-primary btn-sm pb-0 pl-1 pr-1 pt-0">
                    <span class=""></span>
                    HQ/Dzongkhag Office
                </router-link>
            </li>
