                          ...
                          <thead>
                           ...
                           <tbody>
                              <tr v-for='(item, index) in form.items_received' :key="index">
                                  <td>
                                        <select name="class" id="class" class="form-control editable_fields"  v-model="form.class " :class="{ 'is-invalid': form.errors.has('class') }" @change="remove_err('class')">
                                            <option v-for="(item, index) in classList" :key="index" v-bind:value="item.id">{{ item.class }}</option>
                                        </select>
                                  </td>
                                  <td>                          
                                        <input type="number" @change="remove_error('ProjectionNo')" name="ProjectionNo" class="form-control" v-model="form.ProjectionNo" :class="{ 'is-invalid': form.errors.has('ProjectionNo') }"/>
                                  </td>
                                  <td>
...
export default {
    ...
    methods:{
        ...
        mounted() { 
            ...
            this.form.ProjectionNo=this.$route.params.data.ProjectionNo;
