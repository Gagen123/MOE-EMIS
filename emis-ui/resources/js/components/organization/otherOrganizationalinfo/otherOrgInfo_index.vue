        ...
        <div class="container-fluid">
            <ul class="nav nav-pills mb-2" role="tablist">
                ...
                <li class="nav-item active pr-1" @click="activatelink('regularstaff')">
                    <router-link id="regularstaff" to="/slocation_index" class="btn btn-outline-primary btn-sm pb-0 pl-1 pr-1 pt-0">
                        <span class=""></span>
                        Location
                    </router-link>
                </li>
                <li class="nav-item active pr-1" @click="activatelink('regularstaff1')">
                    <router-link id="regularstaff1" to="/connectivity_index" class="btn btn-outline-primary btn-sm pb-0 pl-1 pr-1 pt-0">
                        <span class=""></span>
                        Connectivity
                    </router-link>
                </li>
                <li class="nav-item active pr-1" @click="activatelink('regularstaff2')">
                    <router-link id="regularstaff2" to="/equipment&furniture_index" class="btn btn-outline-primary btn-sm pb-0 pl-1 pr-1 pt-0">
                        <span class=""></span>
                        Equipment & Furniture
                    </router-link>
                </li>
                <li class="nav-item active pr-1" @click="activatelink('regularstaff4')">
                 ...
                 <li class="nav-item active pr-1" @click="activatelink('regularstaff3')">
                    <router-link id="regularstaff3" to="/classMapping_index" class="btn btn-outline-primary btn-sm pb-0 pl-1 pr-1 pt-0">
                        <span class=""></span>
                        Class Mapping
                    </router-link>
                </li>
