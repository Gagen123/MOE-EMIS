<template>
    <div>
        <table id="edit-student-house" class="table table-bordered table-striped table-head-fixed">
            <thead>
                <tr>
            ...
            <tbody>
                <tr>
                     ...
                     <td>Yellow</td>
                     <td>
                         <button class="btn btn-secondary btn-xs" @click="edithouse('1')" type="button"><i class="fa fa-edit"></i> Edit</button>
                     </td>
                </tr>
                <tr>
                    <td>2</td>
        ...
        <div class="modal fade" id="edithouse" tabindex="-1" role="dialog">
