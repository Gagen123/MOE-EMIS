<template>
    <div>
        <form>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <label class="rp-3">Is SEN Student:</label><br>
                    <label><input  type="radio" v-model="student_form.sen" name="sen" id="sen" value="1" tabindex=""/> Yes</label>
                    <label><input  type="radio" v-model="student_form.sen" name="sen" id="sen" value="0" tabindex=""/> No</label>
                    <has-error :form="student_form" field="sen"></has-error>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
            ...
            if(type=="save"){
                ...
                .then((response) =>{
                    if(response.data.data==null){
                         Swal.fire({
                        text: "Sorry! Your SEN details is not mapped to your CID Number  ",
                        icon: 'error',
