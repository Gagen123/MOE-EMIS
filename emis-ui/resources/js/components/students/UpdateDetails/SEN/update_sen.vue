        ...
        <form>
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <label><input  type="radio" v-model="sen" name="sen" id="sen" value="1" tabindex=""/> Yes</label>
                    <label><input  type="radio" v-model="sen" name="sen" id="sen" value="0" tabindex=""/> No</label>
