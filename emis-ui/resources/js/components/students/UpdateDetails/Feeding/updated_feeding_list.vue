        ...
        <table id="updatedfeeding-list-table" class="table table-bordered text-sm table-striped">
            <thead>
                <tr>
                    ...
                    <th >Student Name</th>
                    <th >Student Code</th>
                    <th >No. of Meals (New)</th>
                    <th >No. of Meals (Old)</th>
                    <th >Action</th> 
                </tr>
            </thead>
            <tbody id="tbody">
...
export default {
    ...
    methods:{
        loadDataList(uri='students/loadStudentUpdatesList/feeding'){
            axios.get(uri)
            .then(response => {
                let data = response;
        ...
        showedit(data){
            this.$router.push({name:'edit_updated_feeding',params: {data:data}});
        },
    },
    mounted(){
        this.loadDataList();
