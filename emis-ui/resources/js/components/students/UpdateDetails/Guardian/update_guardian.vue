        ...
        <form>
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label>CID:</label>
                        <input type="number" @change="remove_error('date')" class="form-control" v-model="student_form.date" :class="{ 'is-invalid': student_form.errors.has('date') }" name="date" id="date">
                    </div>
                </div>
            </div>
            <div class="row">
