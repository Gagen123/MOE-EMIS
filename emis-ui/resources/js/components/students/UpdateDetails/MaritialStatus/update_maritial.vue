<template>
    <div>
        <form>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <label class="rp-3">Maritial Status of Parents:</label><br>
                    <label><input  type="radio" v-model="student_form.maritial_status" name="maritial_status" id="maritial_status" value="1" tabindex=""/> Married</label>
                    <label><input  type="radio" v-model="student_form.maritial_status" name="maritial_status" id="maritial_status" value="2" tabindex=""/> Divorced</label>
                    <has-error :form="student_form" field="maritial_status"></has-error>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
    ...
    data(){
        return {
            ...
            student_form: new form({
                ...
                maritial_status: 1,
                remarks:'',
                record_type:'update_maritial_status',
                action_type:'add'
            }),
        }
    },
            ...
            if(type=="save"){
                this.student_form.post('/students/saveStudentUpdates',this.student_form)
                    ...
                    if(response.data.data==null){
                         Swal.fire({
                        text: "Sorry! Your parents Martial details is not mapped to your CID Number  ",
                        icon: 'error',
                     ...
                     this.$router.push('/updated_maritial_list');
                    })
                .catch(() => {
                    console.log("Error......")
                })
