...
export default {
    ...
    created() {
        ...
        this.student_form.scout=this.$route.params.data.StdStudentId+'_'+this.$route.params.data.CeaScoutSectionId;
        this.loadActiveScoutBagde(this.$route.params.data.CeaScoutSectionId);
        this.student_form.badgeEarned=this.$route.params.data.CeaScoutProficiencyBadgeId;
