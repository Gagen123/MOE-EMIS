...
export default {
    ...
    mounted() {
       ...
       $('[data-toggle="tooltip"]').tooltip();
        ...
        this.form.institute_id=this.$route.params.data.institute_id;
         this.form.collegeName=this.$route.params.data.collegeName;
        this.form.studentFemale=this.$route.params.data.studentFemale;
        this.form.studentMale=this.$route.params.data.studentMale;
        this.form.studentTotal=this.$route.params.data.studentTotal;
        this.form.year=this.$route.params.data.year;
        this.form.addAs=this.$route.params.data.addAs;
    },
}
</script>
