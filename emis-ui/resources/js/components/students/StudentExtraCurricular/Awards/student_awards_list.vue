<template>
    <div>
        <table id="list-student-awards" class="table table-bordered table-striped table-head-fixed">
            <thead>
                <tr>
                     <th >No.</th>
                     <th >Student CID</th>
            ...
            <tbody>
                <tr>
                     ...
                     <td>A</td>
                     <td>
                         <button class="btn btn-primary btn-xs" @click="viewstudentawards('1')" type="button"><i class="fa fa-search"></i> View</button>
                     </td>
                </tr>
                <tr>
                    <td>2</td>
        ...
        <div class="modal fade" id="viewstudentawards" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    <h4 class="modal-title">View Student Awards</h4>
...
export default {
    ...
    methods: {
        viewstudentawards: function(){
            $('#viewstudentawards').modal('show');
        },
