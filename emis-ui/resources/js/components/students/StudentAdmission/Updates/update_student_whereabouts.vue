<template>
    <div>
        <form>
            ...
            <div class="form-group row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <label class="mb-0.5">Current Address:</label>
                    <textarea @change="remove_error('current_address')" class="form-control" v-model="student_form.current_address" :class="{ 'is-invalid': student_form.errors.has('current_address') }" name="current_address" id="current_address"></textarea>
                    <has-error :form="student_form" field="current_address"></has-error>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <label class="mb-0.5">Current Engagement:</label>
