            ...
            <div class="card-body">
                <div class="row form-group">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <input class="form-control" v-model="form.studenthealthName" :class="{ 'is-invalid': form.errors.has('dis_name') }" id="studenthealthName" @change="remove_err('studenthealthName')" type="text">
