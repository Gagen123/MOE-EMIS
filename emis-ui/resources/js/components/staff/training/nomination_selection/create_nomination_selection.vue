                            ...
                            <div class="form-group row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <label>Nominee:<span class="text-danger">*</span></label>
                                     <select class="form-control select2" @change="remove_error('participant')" name="participant" id="participant" v-model="form.participant">
                                        <option value="">- Please Select -</option>
                                        <option v-for="(item, index) in staff_list" :key="index" v-bind:value="item.id"> {{ item.cid_work_permit }}, {{ item.name }},{{ item.position_title.name }}</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <span v-for="(nature, index) in nature_of_participantList" :key="index" >
                                        <input type="radio" v-model="form.nature_of_participant" :class="{ 'is-invalid' :form.errors.has('nature_of_participant') }" name="nature_of_participant" id="nature_of_participant" :value="nature"> 
...
export default {
    ...
    methods: {
        ...
        changefunction(id){
            ...
            if(id=="subject2"){ 
                this.form.participant=$('#participant').val();
            }
        },
        addrecords(){
