        ...
        <div class="card card-primary card-outline">
            <div class="card-header pb-1 mb-0 pt-0 mt-0 bg-white">
                <span class="card-title">
                    <b>Disciplinary Record</b>
                </span>
                <span class="fa-pull-right pt-1">
                    <button type="button" class="btn btn-primary text-white btn-sm" @click="showadprocess('list_staff_disciplinary')" id="listnewbtn"><i class="fa fa-list"></i> List</button>
                    <!-- <button type="button" class="btn btn-dark text-white btn-sm" @click="showadprocess('create_staff_disciplinary')" id="addnewbtn"><i class="fa fa-plus"></i> Add New</button> -->
                    <button type="button" class="btn btn-dark text-white btn-sm" id="addnewbtn"><i class="fa fa-plus"></i> Sync</button>
                </span>
            </div>
...
export default {
    ...
    methods: {
        showadprocess(type){
            this.$router.push({name:type,query: {screen_id:this.screen_id, list:this.list,deleteopt:this.deleteopt,editopt:this.editopt}});
		},
        getprivileges(){
