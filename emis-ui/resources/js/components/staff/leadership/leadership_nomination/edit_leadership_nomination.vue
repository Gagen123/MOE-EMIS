                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show tab-content-details" id="nomination-tab" role="tabpanel" aria-labelledby="nomination">
                        ...
                        <div class="row form-group fa-pull-right">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <button class="btn btn-primary" @click="shownexttab('feedback-tab')">Next <i class="fa fa-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row form-group">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div v-for='(nom, index) in nominees' :key="index">
                                        <label class="text-blue text-bold"><b><u> Feedback Provider for {{nom.name}}</u></b></label> 
...
export default {
    ...
    mounted(){
        ...
        axios.get('/staff/staffLeadershipSerivcesController/loadLeadershipSelection/created/'+this.$route.params.data)
        .then((response) =>{  
            let data=response.data.data;
