        ...
        <div class="card card-primary card-outline">
            <div class="card-header pb-1 mb-0 pt-0 mt-0 bg-white"> 
                ...
                <span class="fa-pull-right pt-1">
                    <button type="button" class="btn btn-primary text-white btn-sm" @click="showadprocess('list_leadership_nomination')" id="listnewbtn"><i class="fa fa-list"></i> List</button>
                    <button type="button" class="btn btn-dark text-white btn-sm" @click="showadprocess('create_leadership_nomination')" id="addnewbtn"><i class="fa fa-plus"></i> Add New</button>
                </span>
            </div> 
