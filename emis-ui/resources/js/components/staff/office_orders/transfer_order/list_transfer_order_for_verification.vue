...
export default {
    ...
    methods: {
        loadeditpage(itme){
            this.$router.push({name:"verify_transfer_order",query:{data:itme}});
        },
    },
    mounted(){
        $('.select2').select2();
        ...
        axios.get('/staff/staffOfficeorderController/loadCreatedApplicationForVerification/TransferOrder__Transfer')
        .then((response) =>{
