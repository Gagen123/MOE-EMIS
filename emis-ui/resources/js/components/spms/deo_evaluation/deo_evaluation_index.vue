                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="card-header bg-white pt-2 pb-1 text-right">
                                ...
                                <button type="button" class="btn btn-flat bg-secondary btn-sm"  @click="loadpage('deo_evaluation_dashboard')"><i class="fa fa-tachometer-alt" aria-hidden="true"></i> Dashboard</button>
                            </div>
