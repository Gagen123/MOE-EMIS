<template>
    <div>
        <form class="bootbox-form" autocomplete="off">
            <strong class="ml-3">Edit Action Taken</strong>
            <div class="card-body">
            ...
            agencyInputFormDetails.forEach((item) => {
                schools.forEach(item1 =>{
                    if(item.school_id == item1.id){
                        ...
                        this.form.action_id = item['action_id'];
                        ...
                        this.form.action = item['action_taken'];
                        this.form.action_date = item['action_taken_date'];
                    }
                })
