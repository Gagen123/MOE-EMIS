<template>
    <div>
        <form class="bootbox-form" autocomplete="off">
            <strong class="ml-3">Edit Observation & Recommendation</strong>
            <div class="card-body">
...
export default {
    ...
    methods: {
        ...
        getAgencyInputFormDetail(){
            ...
            .then(response => { 
                ...
                for(let i = 0; data.length > 0; i++){
                    ...
                    this.form.school_id = data[i]['school_id'];
                    this.year = data[i]['input_year'];
                    this.input = data[i]['input'];
                    this.activity = data[i]['activity'];
                    this.output = data[i]['output'];
                    this.form.observation = data[i]['observation'];
                    this.form.recommendation = data[i]['recommendation'];
                    this.form.recommendation_date = data[i]['recommendation_date'];
                }
     ...
     created(){
        ...
        this.form.observation_id = this.$route.params.data.observation_id
