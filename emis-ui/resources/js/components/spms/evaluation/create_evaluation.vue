    ...
    <div>
        <form class="bootbox-form" >
            ...
            <div class="card-footer text-right">
                ...
                <button v-if="currentRoute == 'create_deo_evaluation'" @click.prevent="save('draft_with_deo')" class="btn btn-flat btn-sm btn-primary" ><i class="fa fa-save"></i> Save</button>
                <button v-if="currentRoute == 'create_deo_evaluation'" @click.prevent="save('submit_to_school')" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-paper-plane"></i> Submit to School</button>
            </div>
        </form>
    </div>  
</template>
            ...
            if(validated == true){
                axios.post('spms/saveEvaluation', {data:evalaution_details,org_id:this.org_id,status:this.status,spm_domain_subcat_id:this.spm_domain_subcat_id})
                 .then(() => {
                    ...
                    if(this.currentRoute =='create_deo_evaluation'){
