            ...
            <div class="card-body" >
                <div class="form-group row mt-xl-n2">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <label class="mb-0">Level Category:</label>
                        <select class="form-control select2" id="level_id">
                            <option value="ALL"> ALL</option>
                            <option value="LSS"> Lower Secondary</option>
                            <option value="MSS"> Middle Secondary</option>
...
export default {
    ...
    methods:{
        loadpage:function(){
            ...
            let type=$('#level_id').val();
            let route='class_size_index';
            if(type=="LSS"){
                route='lssClass_size_index';
            }
            if(type=="MSS"){
                route='mssClass_size_index';
            }
            if(type=="HSS"){
              
                route='hssClass_size_index';
            }
