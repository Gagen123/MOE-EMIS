            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <table id="waterTable" class="table w-100  table-sm table-bordered table-striped col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <tbody>
                       ...
                       <tr v-for="(item, index) in ecreducationCenter" :key="index">
...
export default {
    ...
    methods:{
        async generatesdetail(dzo_id){
            this.ecreducationCenter = await this.loadeducationCenter("ECR",dzo_id);
            
            //Ploating Graph
            if(this.ecreducationCenter!=""){
                var peiData   = {
                    labels: [
                        'Lower Secondary',
                        'Primary',
                    ...
                    datasets: [
                        {
                            data: 
                            [this.ecreducationCenter[0].Lower_Secondary_School+this.ecreducationCenter[1].Lower_Secondary_School,
                            this.ecreducationCenter[0].primary_School+this.ecreducationCenter[1].primary_School,
                            this.ecreducationCenter[0].Middle_secondary_school+this.ecreducationCenter[1].Middle_secondary_school,
                            this.ecreducationCenter[0].Higher_Secondary_School+this.ecreducationCenter[1].Higher_Secondary_School],
