        ...
        async generatesdetail(dzo_id){
            ...
            if(this.schooleducationCenter!=""){
                var peiData   = {
                    ...
                    datasets: [
                        {
                            data: [this.schooleducationCenter[0].Lower_Secondary_School+this.schooleducationCenter[1].Lower_Secondary_School,this.schooleducationCenter[0].primary_School+this.schooleducationCenter[1].primary_School,
                            this.schooleducationCenter[0].Middle_secondary_school+this.schooleducationCenter[1].Middle_secondary_school,this.schooleducationCenter[0].Higher_Secondary_School+this.schooleducationCenter[1].Higher_Secondary_School],
