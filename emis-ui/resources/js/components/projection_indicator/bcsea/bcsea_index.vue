                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="card-header bg-white pt-2 pb-1 text-right">
                                <label class="fa-pull-left">Quality Indicators Based on BCSEA Results</label>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods:{
        ...
        async generatesdetail(){
            let indicatorType=$('#indicator').val();
            
            let uri = 'projections/BcseaController/loadIndicatorResult/'+indicatorType;
            try{
