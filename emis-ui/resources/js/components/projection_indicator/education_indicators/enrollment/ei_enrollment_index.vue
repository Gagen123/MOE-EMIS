    ...
    <div>
        <div class="card card-primary card-outline">
            <div class="card-header pt-1 pb-1">
                Education Indicator - Enrollment
            </div>
            <div class="card-body" >
...
export default {
    ...
    methods:{
        loadpage:function(){
            ...
            let route='enrollment_eccd';
            if(type=="PrePrimary"){
                route='enrollment_pre_primary';
            }
            if(type=="Primary"){
                route='enrollment_primary';
            }
            if(type=="Basic"){
                route='enrollment_basic';
            }
            if(type=="Middle"){
                route='enrollment_middle_secondary';
            }
            if(type=="Lower"){
                route='enrollment_lower_secondary';
            }
            if(type=="Higher"){
                route='enrollment_higher_secondary';
            }
            if(type=="Tertiary"){
                route='enrollment_tertiary';
            }
