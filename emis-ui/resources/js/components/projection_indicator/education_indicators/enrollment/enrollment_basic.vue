                ...
                axios.get(uri).then(response => { 
                    ...
                    if(this.studentData!=""){
                        for(let i=0;i<this.studentData.length;i++){
                            if(this.studentData[i].name == "Primary School"){
                                this.primary_private = this.studentData[i].Private_School;
                                this.primary_public = this.studentData[i].Public_School;
                            }
                            if(this.studentData[i].name == "Middle Secondary School"){
                                this.middle_private = this.studentData[i].Private_School;
                                this.middle_public = this.studentData[i].Public_School;
                            }
                            if(this.studentData[i].name == "Lower Secondary School"){
                                this.lower_private = this.studentData[i].Private_School;
                                this.lower_public = this.studentData[i].Public_School;
                            }
                            if(this.studentData[i].name == "Higher Secondary School"){
                                this.higher_private = this.studentData[i].Private_School;
                                this.higher_public = this.studentData[i].Public_School;
                            }
                        }
                        var areaChartData = {
