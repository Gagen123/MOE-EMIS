            ...
            <div class="card-body" >
                <div class="form-group row mt-xl-n2">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <label class="mb-0">Category:<i class="text-danger">*</i></label>
...
export default {
    ...
    methods:{
        loadpage:function(){
            ...
            let route='school_teacher_recur_index';
            
            if(type=="School"){
                route='school_teacher_recur_index';
            }
            if(type=="Tertiary"){
                route='tertiary_teacher_recur_index';
            }
            if(type=="Eccd"){
                route='eccd_teacher_recur_index';
            }
            if(type=="Ecr"){
                route='ecr_teacher_recur_index';
            }
