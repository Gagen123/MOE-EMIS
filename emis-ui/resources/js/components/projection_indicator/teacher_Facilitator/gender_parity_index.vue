...
export default {
    ...
    methods:{
        loadpage:function(){
            ...
            let route='school_teacher_index';
            
            if(type=="School"){
                route='school_teacher_gender_index';
            }
            if(type=="Tertiary"){
                route='tertiary_teacher_gender_index';
            }
            if(type=="Eccd"){
                route='eccd_teacher_gender_index';
            }
            if(type=="Ecr"){
                route='ecr_teacher_gender_index';
            }
