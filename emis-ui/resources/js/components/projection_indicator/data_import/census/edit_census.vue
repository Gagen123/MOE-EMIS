                     ...
                     <div class="tab-pane fade active show tab-content-details" id="application-tab" role="tabpanel" aria-labelledby="basicdetails">
                        <div class="row form-group">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input class="form-control" v-model="form.age" :class="{ 'is-invalid': form.errors.has('age') }" id="age"  type="text">
...
export default {
    ...
    mounted() {
        ...
        this.form.age=this.$route.params.data.age;
        this.form.male=this.$route.params.data.male;
        this.form.female=this.$route.params.data.female;
        this.form.total=parseInt(this.$route.params.data.male)+parseInt(this.$route.params.data.female);
    },
}
</script>
