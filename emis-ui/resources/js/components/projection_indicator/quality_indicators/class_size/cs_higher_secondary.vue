            ...
            try{
                axios.get(uri).then(response => { 
                    ...
                    if(this.studentData!=""){
                        ...
                        this.vii_gpi = this.studentData['VII'];
                        this.viii_gpi = this.studentData['VIII'];
                        this.ix_gpi = this.studentData['IX'];
                        this.x_gpi = this.studentData['X'];
                        this.xi_gpi = this.studentData['XI'];
                        this.xii_gpi = this.studentData['XII'];
                        
                        var areaChartData = {
                            labels  : ['PP', 'I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X', 'XI', 'XII'],
                            datasets: [
                                {
                                    label               : 'Male',
                                    ...
                                    data                : [this.pp_gpi, this.i_gpi, this.ii_gpi, this.iii_gpi, this.iv_gpi, this.v_gpi, this.vi_gpi,
                                                            this.vii_gpi, this.viii_gpi, this.ix_gpi, this.x_gpi, this.xi_gpi, this.xii_gpi]
                                },
                                {
