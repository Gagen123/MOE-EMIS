<template>
    <div>
        <ol class="mb-1 ml-xl-n4 mr-xl-n2" style="background-color:#E5E5E5">
            <li class="form-inline "><h6 class="pt-1">Teacher Requirement Excercise</h6></li>
        </ol>
        <div class="container-fluid">
            <ul class="nav nav-pills mb-2" role="tablist">
                ...
                <li class="nav-item pr-1" onclick="afterclick('regularstaff')">
                    <router-link to="/subsitute_teacher_index" class="btn btn-outline-primary btn-sm pb-0 pl-1 pr-1 pt-0">
                        <span class="fa fa-user-edit"></span>
                        Manage Subsitute Teacher 
                    </router-link>
                </li>
            </ul>
